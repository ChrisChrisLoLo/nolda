...
class SHARP(framebuf.FrameBuffer):
    ...
    def __init__(self, spi, pincs, height=240, width=400, vcom=False):
        ...
        # spi.init()  # Data sheet: should support 2MHz
        spi.init(baudrate=200_000)  # Data sheet: should support 2MHz
        # spi.init(baudrate=200_000, firstbit=machine.SPI.LSB)  # Data sheet: should support 2MHz
        self._spi = spi
        self._pincs = pincs
